...
schools_fit_latent <- model$sample(data = stanbreaker::data_8schools,
...
test_that("rstan_hessian computes a hessian", {
  ...
  hessian_ref = matrix(c(-17.844327, -19.5847602, 2.2255409,  2.225541,  2.225541,  2.225541,  2.225541,  2.225541,  2.225541,  2.225541,
...
test_that("rstan_power_method computes an eigenvalue and an eigenvector", {
  ...
  e_ref = -37.56787
  v_ref = c(0.72000031, 0.64355009, -0.06157088, -0.06967409, -0.07777161,
